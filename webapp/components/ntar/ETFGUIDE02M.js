/*************************************************************************
* @ 서비스경로 : ETFGUIDE02M
* @ 파일명      : ETFGUIDE02M.html ETF 가이드북 > 상세
* @ 작성자      : 90195654
* @ 작성일      : 2024-12-26
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
...
export default class ETFGUIDE02M extends BaseModule {
	
    constructor(elem,data) {
        
    	super(elem);
    	
    	[this.blbrNo, this.setBlbrNo] = this.useState('blbrNo', data.blbrNo);
    }
    ...
    async apiNoticeDetailtDataSet(data) {
        ...
        if(data.notice.PB_BLBR_LINK === '1') {
         	//내부링크
         	if(data.notice.PB_BLBR_IN_LINK_MENU_ID === 'etfGuide01m') {
