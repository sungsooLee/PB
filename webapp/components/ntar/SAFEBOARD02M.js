...
export default class SAFEBOARD02M extends BaseModule {
    ...
    async apiNoticeDetailtDataSet(data) {
        ...
        if(data.notice.PB_BLBR_LINK === '1') {
         	//내부링크
         	if(data.notice.PB_BLBR_IN_LINK_MENU_ID === 'safeBoard01m') {
