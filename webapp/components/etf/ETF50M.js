...
export default class ETF50M extends BaseModule {
    ...
    async apiFndCmrs(data) {
    	...
    	const result = await ApiUtils.sendPost('/api/etf/getFndCmrs.json', param, true);
    ...
    fnd1Dataset(fnd1) {
    	...
    	$$("#fnd1-prdKorlNm").text(fnd1.prdKorlNm); //ETF명
    	$$(".fndNm1").text(fnd1.prdKorlNm); //ETF명
    ...
    fnd2Dataset(fnd2) {
    	...
    	$$("#fnd2-prdKorlNm").text(fnd2.prdKorlNm); //ETF명
    	$$(".fndNm2").text(fnd2.prdKorlNm); //ETF명
